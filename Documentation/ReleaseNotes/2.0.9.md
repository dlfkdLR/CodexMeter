...
- Scrolled settings stay below an opaque toolbar, including when the sidebar is hidden.
...
- 624 automated tests, 0 failures; 9 opt-in environment tests skipped. Release script tests and Universal build passed. The installed app was checked for Settings navigation, both account-menu destinations, and live Used / Remaining changes.
