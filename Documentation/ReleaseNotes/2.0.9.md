...
- The notch's Settings control opens the window reliably. A separate account-switch button sits directly below it, with shortcuts to saved Codex accounts and the Claude Code account settings.
...
- 618 automated tests, 0 failures; 9 opt-in environment tests skipped. Release script tests and Universal build passed. The installed app was checked for Settings navigation, both account-menu destinations, and live Used / Remaining changes.
